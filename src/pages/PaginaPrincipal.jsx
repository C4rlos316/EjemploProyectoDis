...
const PaginaPrincipal = () => {
  ...
  const games = [
    { id: 1, name: 'Cyberpunk 2077', genres: 'Action, Adventure, Role-Playing', image: 'https://via.placeholder.com/150', platform: 'pc', year: '2020 - 2021', description: 'Cyberpunk 2077 is an open-world, action-adventure story set in Night City, a megalopolis obsessed with power, glamour and body modification. You play as V, a mercenary outlaw going after a one-of-a-kind implant that is the key to immortality.', rating: 4.5, reviews: 1000 },
        ...
        >
          {filteredGames.map((game) => (
            <Grid item xs="auto" key={game.id}>
              <GameCard game={game} onClick={() => { setSelectedGame(game); handleOpen(); }} />
            </Grid>
          ))}
        </Grid>
      </Box>
